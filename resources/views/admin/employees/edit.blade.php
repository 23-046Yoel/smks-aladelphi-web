...
<head>
    <meta charset="UTF-8">
    <title>Edit Pegawai - Admin</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input, select { padding: 12px 16px; border: 2px solid #eee; border-radius: 12px; font-size: 0.9rem; font-family: 'Inter', sans-serif; transition: 0.2s; }
        input:focus, select:focus { outline: none; border-color: #e30613; }
        ...
        .current-photo { width: 100px; height: 100px; border-radius: 15px; object-fit: cover; border: 3px solid #e30613; margin-bottom: 10px; display: block; }
...
<div class="main">
    <div class="topbar">
        ...
        <h1>Edit Data Pegawai: {{ $employee->name }}</h1>
    </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="employee_type" required>
                            <option value="guru" {{ $employee->employee_type == 'guru' ? 'selected' : '' }}>Guru</option>
                            <option value="staff" {{ $employee->employee_type == 'staff' ? 'selected' : '' }}>Staff</option>
                            <option value="tata_usaha" {{ $employee->employee_type == 'tata_usaha' ? 'selected' : '' }}>Tata Usaha</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Jabatan *</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" value="{{ old('subject', $employee->subject) }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group full">
                        ...
                        @if($employee->photo)
                            <img src="{{ Storage::url($employee->photo) }}" class="current-photo" alt="Foto saat ini">
                            <small style="color:#888;">Foto saat ini. Upload baru untuk mengganti.</small>
                        @endif
